...
Pod::Spec.new do |s|
  s.name             = "FerrisMenu"
  s.version          = "0.1.0"
  s.summary          = "A short description of FerrisMenu."
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/FerrisMenu"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Gene De Lisa" => "gene@rockhoppertech.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/FerrisMenu.git", :tag => s.version.to_s }
